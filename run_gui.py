...
def gen_adv_features_test():
    ...
    np.save('./npys/e2/testlabels.npy', labels, allow_pickle=False)

    np.save('./npys/e2/advoutput.npy', out_output, allow_pickle=False)
    np.save('./npys/e2/advdata.npy',out_data,allow_pickle=False)
...
def gen_adv_features_examples():
    ...
    np.save('./npys/examples/testlabels.npy', labels, allow_pickle=False)

    np.save('./npys/examples/advoutput.npy', out_output, allow_pickle=False)
    np.save('./npys/examples/advdata.npy',out_data,allow_pickle=False)
